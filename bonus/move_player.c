...
/*   Updated: 2025/02/02 14:55:21 by arekoune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (mlx_is_key_down(map->mlx, MLX_KEY_DOWN) || mlx_is_key_down(map->mlx,
			MLX_KEY_S))
		move_p(map, -1, map->player.angel);
	if ((mlx_is_key_down(map->mlx, MLX_KEY_UP) || mlx_is_key_down(map->mlx,
				MLX_KEY_W)))
	{
